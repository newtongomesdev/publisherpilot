    ...
    <DashboardShell userName={user.name} workspaceName={workspace.name}>
      <div className="space-y-8 animate-in fade-in duration-500">
        <div className="relative">
          ...
          <h1 className="text-3xl font-semibold tracking-tight text-zinc-100 pl-4">Gerador de Imagens</h1>
          <p className="text-zinc-400 mt-2 pl-4 max-w-2xl">
            Criação de imagens por Inteligência Artificial via Fal.ai. Gere fotos cinematográficas, ilustrações 3D e artes ultra-realistas instantaneamente.
          </p>
        </div>
