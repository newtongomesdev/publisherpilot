    ...
    <DashboardShell userName={user.name} workspaceName={workspace.name}>
      <div className="space-y-8 animate-in fade-in duration-500">
        <div className="relative">
          ...
          <h1 className="text-3xl font-semibold tracking-tight text-zinc-100 pl-4">Busca</h1>
          <p className="text-zinc-400 mt-2 pl-4 max-w-2xl">
            Metasearch via SearXNG — busca anônima em Google, Bing, DuckDuckGo, Pexels, Pixabay e mais.
          </p>
        </div>
